...
GeneratorConfig GeneratorConfig::get_attention_default_config() {
  return {
      ...
      {{int3{0, -1, 1}, int3{0, 2, -1}, int3{0, 1, -1}},
       {{0, -1, -1}, {0, 2, -1}, {0, 1, -1}},
       {{0, -1, -1}, {0, -1, -1}},
       {{0, 1, -1}, {0, 1, -1}}} /* imap_to_explore*/,
      {int3{0, 1, -1}, int3{0, 2, 1}, int3{0, 2, -1}, int3{0, -1, -1}} /* omap_to_explore */,
      {dim3{16, 1, 1}, dim3{16, 2, 1}} /* grid_dim_to_explore*/,
